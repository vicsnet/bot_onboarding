...
var fetchProtocols = function () {
    var mockFetch = jest.mocked(node_fetch_1.default);
...
var mockHasAddress = function (address) {
    return address !== forta_agent_1.ethers.constants.AddressZero;
};
...
describe("Victim Identifier tests suite", function () {
    ...
    it("should not return a preparation stage victim when the victim is WETH address", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockTxEvent, createdContractAddress, extractedAddress1, i, victims;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockTxEvent = new test_1.TestTransactionEvent().setBlock(444123).setTo("");
                    ...
                    createdContractAddress = "0xBd770416a3345F91E4B34576cb804a576fa48EB1";
                    extractedAddress1 = WETH_ADDRESS;
                    mockProvider.addStorage(createdContractAddress, 0, 444123, extractedAddress1);
    ...
    it("should not return an exploitation stage victim if the victim is WETH address", function () { return __awaiter(void 0, void 0, void 0, function () {
        var TRANSFER_IFACE, FROM, TO, event, data, mockTxEvent, fetch, Response, callCount, TOKEN_IFACE, victims;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    TRANSFER_IFACE = new utils_1.Interface([constants_1.ERC20_TRANSFER_EVENT]);
                    ...
                    event = TRANSFER_IFACE.getEvent("Transfer");
                    data = [FROM, TO, forta_agent_1.ethers.BigNumber.from("3424324324423423")];
                    mockTxEvent = new test_1.TestTransactionEvent().setBlock(5444123).addEventLog(event, WETH_ADDRESS, data);
                    mockProvider.setCode(FROM, "0x1", 5444123);
                    jest.mock("node-fetch");
                    fetch = require("node-fetch");
                    Response = jest.requireActual("node-fetch").Response;
