...
var TokenInfoFetcher = /** @class */ (function () {
    ...
    TokenInfoFetcher.prototype.getTotalSupply = function (block, tokenAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var token, key, retryCount, totalSupply, i, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = this.tokenContract.attach(tokenAddress);
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i <= retryCount)) return [3 /*break*/, 7];
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 6]);
                    ...
                    case 4:
                        ...
                        if (err_1 instanceof Error) {
                            console.log("Error fetching total supply for token ".concat(tokenAddress, ": ").concat(err_1.message));
                        }
                        else {
                            console.log("Unknown error when fetching total supply: ".concat(err_1));
                        }
                        if (i === retryCount) {
                            totalSupply = ethers_1.ethers.constants.MaxUint256;
                            console.log("Failed to fetch total supply for ".concat(tokenAddress, " after retries, using default max value ").concat(totalSupply.toString()));
                            return [3 /*break*/, 7];
                        }
    ...
    TokenInfoFetcher.prototype.getSymbolOrName = function (chainId, block, tokenAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var key, symbol, token, _a, makerLikeToken, _b, _c, _d, _e;
    ...
    TokenInfoFetcher.prototype.getValueInUsd = function (block, chainId, amount, token) {
        return __awaiter(this, void 0, void 0, function () {
            var response, usdPrice, foundInCache, i, key, chain, retries, _a, chain, _b, _c, tokenAmount, decimals;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        foundInCache = false;
                        for (i = block - 4; i <= block; i++) {
                            key = "usdPrice-".concat(token, "-").concat(i);
                        ...
                        if (!!foundInCache) return [3 /*break*/, 18];
                        if (!(token === "native")) return [3 /*break*/, 8];
                    ...
                    case 12:
                        _b = _d.sent();
                        if (chainId === 10) {
                            this.tokensPriceCache.set("usdPrice-".concat(token, "-").concat(block), 0);
                            return [2 /*return*/, 0];
                    ...
                    case 17:
                        ...
                        _d.label = 18;
                    case 18:
                        if (!(token === "native")) return [3 /*break*/, 19];
                        tokenAmount = ethers_1.ethers.utils.formatEther(amount);
                        return [3 /*break*/, 21];
                    case 19: return [4 /*yield*/, this.getDecimals(block, token)];
                    case 20:
                        decimals = _d.sent();
                        tokenAmount = ethers_1.ethers.utils.formatUnits(amount, decimals);
                        _d.label = 21;
                    case 21: return [2 /*return*/, Number(tokenAmount) * usdPrice];
                }
            });
        });
    };
