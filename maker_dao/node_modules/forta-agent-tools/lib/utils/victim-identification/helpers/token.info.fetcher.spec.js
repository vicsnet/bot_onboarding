...
describe("TokenInfoFetcher tests suite", function () {
    ...
    it("should fetch token decimals and use cache correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _i, TEST_DECIMALS_1, _a, block, decimals, fetchedDecimals_1, fetchedDecimals, _b, TEST_DECIMALS_2, _c, block, decimals, fetchedDecimals_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                ...
                case 2:
                    fetchedDecimals_1 = _d.sent();
                    expect(fetchedDecimals_1).toStrictEqual(decimals);
                    _d.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4:
                    expect(mockProvider.call).toBeCalledTimes(5);
                    return [4 /*yield*/, fetcher.getDecimals(121, (0, __1.createAddress)("0x1234"))];
                case 5:
                    ...
                    _d.label = 6;
                case 6:
                    if (!(_b < TEST_DECIMALS_2.length)) return [3 /*break*/, 9];
                    _c = TEST_DECIMALS_2[_b], block = _c[0], decimals = _c[1];
                    return [4 /*yield*/, fetcher.getDecimals(block, tokenAddress)];
                case 7:
                    fetchedDecimals_2 = _d.sent();
                    expect(fetchedDecimals_2).toStrictEqual(decimals);
                    _d.label = 8;
                case 8:
                    _b++;
                    return [3 /*break*/, 6];
    ...
    it("should fetch the value in USD correctly", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    chainId = 1;
                    mockFetch = jest.mocked(node_fetch_1.default);
