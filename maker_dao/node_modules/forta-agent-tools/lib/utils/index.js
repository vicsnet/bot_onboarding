...
exports.VictimIdentifier = exports.MulticallContract = exports.MulticallProvider = exports.CachedContract = exports.ProviderCache = exports.NetworkManager = exports.createTransactionHash = exports.toChecksumAddress = exports.createChecksumAddress = exports.createAddress = exports.padAddress = void 0;
...
var createTransactionHash = function (txParams) {
    var tx = forta_agent_1.ethers.utils.serializeTransaction(txParams);
    return forta_agent_1.ethers.utils.keccak256(tx);
};
