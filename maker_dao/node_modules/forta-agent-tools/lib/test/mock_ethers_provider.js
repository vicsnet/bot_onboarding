...
var MockEthersProvider = /** @class */ (function () {
    ...
    MockEthersProvider.prototype.setTransaction = function (transaction) {
        this.setTransactionResponse(transaction);
        this.setTransactionReceipt(transaction);
    };
    MockEthersProvider.prototype.setTransactionResponse = function (transaction) {
        (0, jest_when_1.when)(this.getTransaction)
            .calledWith(transaction.hash)
            .mockReturnValue(Promise.resolve(transaction.getTransactionResponse()));
    };
    MockEthersProvider.prototype.setTransactionReceipt = function (transaction) {
        (0, jest_when_1.when)(this.getTransactionReceipt)
