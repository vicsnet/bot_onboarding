...
var mock_transaction_data_1 = __importDefault(require("./mock_transaction_data"));
...
describe("MockEthersProvider tests suite", function () {
    ...
    it("should return the mocked transaction response", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockTransactionData, txParams, transactionResponse, txResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockTransactionData = new mock_transaction_data_1.default();
                    txParams = {
                        nonce: 1,
                        gasLimit: forta_agent_1.ethers.BigNumber.from(21000),
                        gasPrice: forta_agent_1.ethers.BigNumber.from(1000000000),
                        to: (0, utils_1.createAddress)("0x67"),
                        value: forta_agent_1.ethers.utils.parseEther("1"),
                        data: "0x",
                        chainId: 1,
                        from: (0, utils_1.createAddress)("0x87"),
                        timestamp: Date.now(),
                        blockHash: forta_agent_1.ethers.utils.keccak256("0x1234"),
                        blockNumber: 1337,
                        confirmations: 1,
                        maxFeePerGas: forta_agent_1.ethers.BigNumber.from(1000000000),
                        maxPriorityFeePerGas: forta_agent_1.ethers.BigNumber.from(1000000000),
                        r: "0x",
                        s: "0x",
                        v: 0,
                        raw: "0x",
                    ...
                    return [4 /*yield*/, mockProvider.getTransaction(mockTransactionData.hash)];
                case 1:
                    transactionResponse = _a.sent();
                    expect(transactionResponse).toStrictEqual(mockTransactionData.getTransactionResponse());
                    mockTransactionData.setHash(forta_agent_1.ethers.utils.hexlify(forta_agent_1.ethers.utils.randomBytes(32)));
                    mockProvider.setTransaction(mockTransactionData);
                    return [4 /*yield*/, mockProvider.getTransaction(mockTransactionData.hash)];
                case 2:
                    txResponse = _a.sent();
    ...
    it("should return the mocked transaction receipt", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockTransactionData, txReceiptParams, transactionReceipt, txReceipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockTransactionData = new mock_transaction_data_1.default();
                    txReceiptParams = {
                        to: (0, utils_1.createAddress)("0x67"),
                        from: (0, utils_1.createAddress)("0x87"),
                        contractAddress: (0, utils_1.createAddress)("0x87"),
                        transactionIndex: 0,
                        gasUsed: forta_agent_1.ethers.BigNumber.from(21000),
                        logsBloom: "0x",
                        blockHash: forta_agent_1.ethers.utils.keccak256("0x1234"),
                        blockNumber: 1337,
                        confirmations: 1,
                        cumulativeGasUsed: forta_agent_1.ethers.BigNumber.from(21000),
                        byzantium: true,
                        logs: [],
                        status: 1,
                        type: 1,
                        effectiveGasPrice: forta_agent_1.ethers.BigNumber.from(1000000000),
                        root: "0x",
                    };
                    mockTransactionData.setTransactionReceipt(txReceiptParams);
                    mockProvider.setTransaction(mockTransactionData);
                    return [4 /*yield*/, mockProvider.getTransactionReceipt(mockTransactionData.hash)];
                case 1:
    ...
    it("should return the mocked transaction data when set transaction is used", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mockTransactionData, txParams, transactionResponse, transactionReceipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockTransactionData = new mock_transaction_data_1.default();
                    txParams = {
                        ...
                        gasPrice: forta_agent_1.ethers.BigNumber.from(1000000000),
                        to: (0, utils_1.createAddress)("0x67"),
                        value: forta_agent_1.ethers.BigNumber.from(1000000000),
                        data: "0x",
                        chainId: 1,
                        from: (0, utils_1.createAddress)("0x87"),
                        timestamp: Date.now(),
                    ...
                    mockTransactionData.setTransactionResponse(txParams);
                    mockTransactionData.setTransactionReceipt(txParams);
                    mockProvider.setTransaction(mockTransactionData);
                    return [4 /*yield*/, mockProvider.getTransaction(mockTransactionData.hash)];
                case 1:
                    transactionResponse = _a.sent();
